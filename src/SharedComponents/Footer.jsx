    ...
    >
      <div className="bg-black/75 ">
        <div className="w-[80%] mx-auto text-center max-w-[1920px]">
          <div className="text-5xl pt-20 pb-4 ">
            WE ARE READY TO GIVE YOU THE BEST DINING EXPERIENCE
          </div>
          <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-1 lg:gap-4 items-center justify-center">
            <div className=" text-center my-5 lg:py-10">
              <FaRegClock className="text-3xl text-accent mx-auto lg:my-3" />
            ...
            <div className=" text-center my-5 lg:py-10">
              <FaPhoneVolume className="text-2xl text-accent mx-auto lg:my-3" />
            ...
            <div className=" text-center my-5 lg:py-10">
              <FiMail className="text-3xl text-accent mx-auto lg:my-3" />
            ...
            <div className=" text-center my-5 lg:py-10">
              <IoLocationOutline className="text-4xl text-accent mx-auto lg:my-3 " />
